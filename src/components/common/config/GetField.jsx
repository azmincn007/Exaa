...
const specialFields = {
  ...
  totalFloors: { type: 'select', label: "Total Floors", options: generateFloorOptions(20), rules: {} },
  floorNo: { type: 'select', label: "Floor Number", options: generateFloorOptions(20), rules: {} },
  ...
  bedrooms: { type: 'select', label: "Bedrooms", options: [{ id: "1", name: "1" }, { id: "2", name: "2" }, { id: "3", name: "3" }, { id: "4", name: "4" }, { id: "4+", name: "4+" }], rules: {} },
  bathrooms: { type: 'select', label: "Bathrooms", options: [{ id: "1", name: "1" }, { id: "2", name: "2" }, { id: "3", name: "3" }, { id: "4", name: "4" }, { id: "4+", name: "4+" }], rules: {} },
  projectName: { type: 'text', label: "Project Name", rules: {} },
  rtoCode: { type: 'select', label: "RTO Code", options: vehicleData.rtoCodes },
  carParking: { type: 'select', label: "Car Parking", options: [{ id: "1", name: "1" }, { id: "2", name: "2" }, { id: "3", name: "3" }, { id: "4", name: "4" }], rules: {} },
  noOfOwners: { type: 'select', label: "Number of Owners", options: [{ id: "1", name: "1" }, { id: "2", name: "2" }, { id: "3", name: "3" }, { id: "4", name: "4" }, { id: "5+", name: "5+" }], rules: {} },
  motorPower: { type: 'number', label: "Motor Power" },
  engineCC: { type: 'select', label: "Engine CC", options: vehicleData.engineCC, rules: {} },
  buyYear: { type: 'select', label: "Buy Year", options: vehicleData.buyYear, rules: {} },
  maintenance: { type: 'number', label: "Maintenance", rules: {} },
  length: { type: 'number', label: "Length (in feet)", rules: {} },
  breadth: { type: 'number', label: "Breadth (in feet)", rules: {} },
  ...
  furnishing: { type: 'select', label: "Furnishing", options: ["Furnished", "Semi-Furnished", "Unfurnished"], rules: {} },
  constructionStatus: { type: 'select', label: "Construction Status", options: ["New Launch", "Under Construction", "Ready to Move"], rules: {} },
  salaryPeriod: { type: 'select', label: "Salary Period", options: vehicleData.salaryPeriod, rules: {} },
  transmission: { type: 'radio', label: "Transmission", options: ["Manual", "Automatic"] },
  year: { type: 'select', label: "Year of Manufacture", options: vehicleData.years, rules: {} },
  fuel: { type: 'radio', label: "Fuel", options: ["Diesel", "Petrol", "CNG & Hybrids", "LPG", "Electric"], rules: null },
  kmDriven: { type: 'select', label: "KM Driven", options: vehicleData.kmDriven, rules: {} },
  positionType: { type: 'select', label: "Position Type", options: vehicleData.positionTypes, rules: {} },
  qualification: { type: 'select', label: "Qualification", options: vehicleData.qualifications, rules: {} },
