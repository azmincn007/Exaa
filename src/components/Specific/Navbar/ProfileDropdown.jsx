...
const ProfileDropdown = ({ onLogout,onShowPackagesAndOrders  }) => (
  <div className="absolute right-0 mt-2 w-64 bg-white rounded-md shadow-lg py-1 z-30">
   ...
   <button className="block w-full text-center px-4 py-[5px] text-sm text-white bg-[#16273C] rounded-md ">
    ...
    <button 
      ...
      className="block w-full text-left px-4 py-[5px] text-sm text-gray-700 hover:bg-blue-500 hover:text-white bg-[#0071BC66]"
    >
    ...
    <button
      onClick={onLogout}
      className="block w-full text-left px-4 py-[5px] text-sm text-gray-700 hover:bg-blue-500 hover:text-white"
    >
